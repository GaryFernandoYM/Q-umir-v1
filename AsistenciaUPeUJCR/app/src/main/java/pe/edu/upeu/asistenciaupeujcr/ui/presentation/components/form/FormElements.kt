...
<<<<<<< HEAD
    CUI,TIPOCUI,MATERENTRE,HORAREG,MODFH,ACTIVIDADID,UBICACION,CONTENIDO,AUTOR,ESTADOO
=======
    CUI,TIPOCUI,MATERENTRE,HORAREG,MODFH,ACTIVIDADID,UBICACION, TYPE_ENTITY
